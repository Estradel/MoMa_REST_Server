...
class AnimationEngine(multiprocessing.Process):
    def __init__(self, animator_class: type[AnimatorInterface], source_path: str,
                 frame_queue: multiprocessing.Queue, shm_name: str, frame_size: int, buffer_count: int = 3, fps: int = 60):
        super().__init__()
    ...
    def run(self):
        ...
        try:
            ...
            while self.running.is_set():
                ...
                animator.write_frame_to_buffer(shm.buf, offset)
